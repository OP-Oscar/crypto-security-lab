...
// Making secondary mock DB due to new users and unable to edit original
let db2 = db
...
//     req.session.success = 'Logged in!-Sessions in place';
...
//       req.session.username = username
//       req.session.success = `Welcome ${username}, your new account is complete.`
//       res.redirect('/login/success')
//   }
//   // TODO: If the user already exists, display an error message
//   else{
//     req.session.error = `Sorry, something went wrong >=D `
